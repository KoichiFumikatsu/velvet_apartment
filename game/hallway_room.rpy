        ...
        for ri, room in enumerate(floor.rooms):
            if room.occupied:
                ...
                textbutton "Puerta vacía\nAcondicionar\n%s" % vdisplay.cost_label(ccost):
                    action Function(act, velvet.hotel.condition_room, gs, floor, room, make_placeholder_guest(current_floor, ri))
...
screen room(room):
    ...
    if room.guest is None:
        # Salvaguarda: sólo se debería entrar a puertas ocupadas.
        vbox:
